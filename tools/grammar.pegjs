 ...
 * JavaScript Grammar
 *
 * Based on grammer from ECMA-262, 6 Edition and based on an example file found
 * at https://github.com/pegjs/pegjs/blob/master/examples/javascript.pegjs
 *
 * This file is just an experimentation
 */
...
Start
  = __ body:Program __ {
      return new options.UglifyJS.AST_Toplevel({ start: body.start, body: body, end: body.end });
    }
